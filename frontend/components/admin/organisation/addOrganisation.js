...
import { getlistSector, getIndustryList } from '../../../redux/actions/organisation/addsector'
        ...
        if (Id) {
            initialValues = {
                ...
                cms: [{
                    ...
                    awardsAndRecognisations: orgdata?.OrganisationCMS[0]?.awardsAndRecognisations,
            ...
            initialValues.levelOfCompany = orgdata?.CompanyLevel?.map((item, index) => {
                return {
            ...
            initialValues.businessNature = orgdata?.BusinessNature?.map((item, index) => {
                return {
                                                ...
                                                <Field name={`orgCatgeory`}>
                                                    {({ input, meta }) => (
                                                        <>
                                                            ...
                                                            >
                                                                <option value="">Select an Organisation Category</option>
                                                                        ...
                                                                        <div className="d-flex mt-2 margin_bottom">
                                                                            ...
                                                                            {fields.length > 1 ? (
                                                                                <div
                                                                                    ...
                                                                                    onClick={() => {
                                                                                        fields.remove(index)
                                                                                        handleSectorremove(values, values.sector[index])
                                                                                    }}
                                                                                >
                                                                                    <img
                                                                                        className="add_remove_icon"
                                                            ...
                                                            >
                                                                ...
                                                                {statelist &&
                                                                    statelist?.map((item, index) => {
                                                                        return (<option value={item?.id} key={index}>{item?.state}</option>)
                                                                    })
                                                                }
                                                            </select>
                                                            <div className="text-end">
                                            ...
                                            <Col md={12} lg={6}>
                                                <Field name={`yourRole`}>
                                                    {({ input, meta }) => (
                                                        <div>
                                                            <div className="d-flex">
                                                                <label className="signup_form_label"> Your Role in Organisation</label>
                                                                {meta.error && meta.touched && (
                                                                    <span className="text-danger required_msg">
                                                                        {meta.error}
                                                                    </span>
                                            ...
                                            <Col md={12} lg={6}>
                                                <Field name={`logo`}>
                                                    {({ input, meta }) => (
                                                        <div>
                                                            <div className="d-flex">
                                                                <label className="signup_form_label">Company's Logo</label>
                                                                {meta.error && meta.touched && (
                                                                    <span className="text-danger required_msg">
                                                                        {meta.error}
                                                                    </span>
                                            ...
                                            <Col md={12} lg={6}>
                                                <Field name={`cover`}>
                                                    {({ input, meta }) => (
                                                        <div>
                                                            <div className="d-flex">
                                                                <label className="signup_form_label">Company's Cover</label>
                                                                {meta.error && meta.touched && (
                                                                    <span className="text-danger required_msg">
                                                                        {meta.error}
                                                                    </span>
