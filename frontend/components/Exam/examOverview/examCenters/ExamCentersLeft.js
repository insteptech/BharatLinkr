...
const CentersBars=["examCentreIntro","listOfExamCentres","createdAt","updatedAt"]
const ExamCentersLeft = (props) => {
        ...
        <div className="card_sec">
          <div lassName="card_mid search_left_card">
            <ul className="nav search_page_left_tabs_box">
              {CentersBars &&
                CentersBars?.map((steps, stepsIndex) => (
...
export default ExamCentersLeft