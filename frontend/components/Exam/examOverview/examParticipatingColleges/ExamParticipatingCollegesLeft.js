...
const ParticipatingCollegeBars = [
  "listOfTopCollegesAcceptingJEE",
  "createdAt",
  "updatedAt",
];
const ExamParticipatingCollegesLeft = (props) => {
      ...
      <div className="card_sec">
        <div lassName="card_mid search_left_card">
          <ul className="nav search_page_left_tabs_box">
            {ParticipatingCollegeBars &&
              ParticipatingCollegeBars?.map((steps, stepsIndex) => (
...
export default ExamParticipatingCollegesLeft;
