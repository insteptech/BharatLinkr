...
import { Peopledata } from "./peopleCard";
import { OrganisationData } from "./organisationcard";

function AllCard() {
  const newArray = [...Peopledata, ...Collegedata, ...OrganisationData];
...
//         <>
//           <PeopleCard data={fileredData} />

//           <ProfileCollegeCard data={fileredData} />
//         </>
//       ) : (
